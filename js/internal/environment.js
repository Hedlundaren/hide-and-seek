var Environment = (function () {
    ...
    Environment.prototype.createGrid = function (X, Y, envSize) {
        ...
        Environment._background = new Square($V([xStart - bg_margin, yStart - bg_margin]), "wall", X * (squareSize + margin) + 2 * bg_margin);
        Environment._background.setType("wall");
        var backdrop2 = new Square($V([xStart, yStart]), "wallhit", X * (squareSize + margin));
